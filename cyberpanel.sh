...
Interactive_Mode() {
    ...
    Input_Number=1  # Automatically select option 1 without interactive mode
    echo "Automatically selected option 1."
    echo ""
...
Full_Installation=Y  # Automatically set to "Y"
echo ""

# Set switches for Postfix, PowerDNS, and PureFTPd to "On"
Postfix_Switch="On"
PowerDNS_Switch="On"
PureFTPd_Switch="On"
...
Remote_MySQL="N"  # Automatically set to "N" for no remote MySQL connection
echo ""

if [[ "$Remote_MySQL" == "N" ]]; then
...
printf "%s" ""
Tmp_Input=""  # Automatically set to an empty string for the latest version
echo ""
...
Tmp_Input="r"  # Automatically set to "r" for random password
...
Tmp_Input="Y"  # Automatically set to "Y" for yes
echo ""
...
printf "%s" "Please select [Y/n]: "
Tmp_Input="n"  # Automatically set to "n" for no
echo ""
